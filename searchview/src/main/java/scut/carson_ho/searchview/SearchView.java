...
public class SearchView extends LinearLayout {
    ...
    private ImageView history_clear;  // 删除搜索记录按键
    ...
    private void initView(){
       ...
       // search_block.setBackgroundColor(searchBlockColor);
        ...
        // 5. 删除历史搜索记录 按钮
        history_clear = findViewById(R.id.tv_clear);
        history_clear.setVisibility(INVISIBLE);
        // 6. 返回按键
    ...
    private void queryData(String tempName) {
        ...
        if (tempName.equals("") && cursor.getCount() != 0){
            history_clear.setVisibility(VISIBLE);
        }
        else {
            history_clear.setVisibility(INVISIBLE);
        };
